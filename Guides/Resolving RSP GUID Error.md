...
1. Trigger a manual instance backup in RSP and verify that the backup completes without error. See the [Trigger Manual RSP Backups](https://github.com/JThomas404/SAP-HANA-Professional-Portfolio/blob/main/Guides/Windows%20Servers/Trigger%20Manual%20RSP%20Backups.md) KBA for guidance.
